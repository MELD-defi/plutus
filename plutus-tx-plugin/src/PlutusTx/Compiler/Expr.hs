...
compileExpr e = withContextM 2 (sdToTxt $ "Compiling expr:" GHC.<+> GHC.ppr e) $ do
    ...
    case e of
        -- Lazy ||
        GHC.App (GHC.App (GHC.Var fid) a) b | GHC.getOccString fid == "||" -> compileExpr $ GHC.mkIfThenElse a a b
        -- Lazy &&
        GHC.App (GHC.App (GHC.Var fid) a) b | GHC.getOccString fid == "&&" -> compileExpr $ GHC.mkIfThenElse a b a
